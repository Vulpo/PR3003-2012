...
En développant et en prenant k=m, g=1 et $a=l_0$ (données de l'énoncé), on obtient :\\
 ...
 $\frac{x}{1+x^2} + [\frac{x}{\sqrt{1+x^2}} + \sqrt{x^4/4+1}.\sqrt{1-\frac{1}{1+x^2}}.\sqrt{1-\frac{x^2}{1+x^4/4}}]-a.\frac{1}{\sqrt{1+x^2}}.\frac{x}{\sqrt{1+x^4/4}} + a.\sqrt{1-\frac{1}{1+x^2}}.\sqrt{1-\frac{x^2}{1+x^4/4}} - \ddot{x}.\sqrt{1+x^2} - \frac{\dot{x}^2.x}{\sqrt{1+x^2}} = 0$
